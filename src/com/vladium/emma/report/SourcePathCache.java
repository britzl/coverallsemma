...
final class SourcePathCache
{
    ...
    public SourcePathCache (final String [] sourcepath, final boolean removeNonExistent)
    {
        ...
        final List<File> _sourcepath = new ArrayList<File> (sourcepath.length);
        ...
        m_packageCache = new HashMap<String, CacheEntry> ();
    }
    ...
    public synchronized File find (final String packageVMName, final String name)
    {
        ...
        CacheEntry entry = m_packageCache.get (packageVMName);
    ...
    private final Map<String, CacheEntry> /* packageVMName:String->CacheEntry */ m_packageCache; // never null
