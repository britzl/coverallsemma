...
interface IItemAttribute
{
    ...
    abstract class Factory
    {
        ...
        {
            @Override
			public Comparator<IItem> comparator ()
            {
                return m_comparator;
            }  
            ...
            private static final class NameComparator implements Comparator<IItem>
            {
                @Override
				public int compare (final IItem l, final IItem g)
                {
                    return l.getName ().compareTo (g.getName ());
                }
                                                     ...
                                                     implements IItemAttribute
        {
            ...
            private final class FractionComparator implements Comparator<IItem>
            {
                @Override
				public int compare (final IItem l, final IItem g)
                {
                    final double nil = l.getAggregate (m_numeratorAggregateID);
                    final double dil = l.getAggregate (m_denominatorAggregateID);
                    
                    final double nig = g.getAggregate (m_numeratorAggregateID);
                    final double dig = g.getAggregate (m_denominatorAggregateID);
