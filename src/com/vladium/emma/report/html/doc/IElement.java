    ...
    abstract class Factory
    {
                                         ...
                                         implements IElement
        {
			...
			public void emit (final HTMLWriter out)
            {
                ...
                for (Iterator<IContent> c = m_contents.iterator (); c.hasNext (); )
                {
                    final IContent content = c.next ();
                    content.emit (out);
                }
            ...
            ElementImpl (final Tag tag, final AttributeSet attrs)
            {
                ...
                m_contents = new ArrayList<IContent> ();
            }

            
            protected final List<IContent> m_contents;
