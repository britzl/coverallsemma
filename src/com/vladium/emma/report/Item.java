...
abstract class Item implements IItem
{
    ...
    @Override
	public final Iterator<IItem> getChildren ()
    {
        return m_children.iterator ();
    }
    
    @Override
	public final Iterator<IItem> getChildren (final ItemComparator /* IItem */ order)
    {
	...
	public int getAggregate (final int type)
    {
        ...
        if (value < 0)
        {
            ...
            value = 0;
            for (Iterator<IItem> children = m_children.iterator (); children.hasNext (); )
            {
    ...
    {
        m_parent = parent;
        m_children = new ArrayList<IItem> ();
    ...
    private final List<IItem> m_children;
