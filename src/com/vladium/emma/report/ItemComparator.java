 ...
 */
public
interface ItemComparator extends Comparator<IItem>
{
    // public: ................................................................
    ...
    {
        public static ItemComparator create (final Integer [] attributeIDsWithDir, final int unitsID)
        {
            ...
            final Comparator<IItem> [] comparators = new Comparator [attributeIDsWithDir.length >> 1];
            for (int a = 0; a < attributeIDsWithDir.length; a += 2)
            {
                final int attributeID = attributeIDsWithDir [a];
                
                final Comparator<IItem> comparator = IItemAttribute.Factory.getAttribute (attributeID, unitsID).comparator ();
        ...
        {
            @Override
			public int compare (final IItem l, final IItem g)
            {
                return 0; 
            }
        ...
        private static final class ReverseComparator implements ItemComparator
        {
            ...
            ReverseComparator (final Comparator<IItem> comparator)
            {
                m_comparator = comparator;
            }
            
            
            private final Comparator<IItem> m_comparator;
        ...
        private static final class CompositeComparator implements ItemComparator
        {
            ...
            CompositeComparator (final Comparator<IItem> [] comparators)
            {
                m_comparators = comparators;
            }
            
            
            private final Comparator<IItem> [] m_comparators;
