...
abstract class ReportProperties implements IAppErrorCodes
{
    ...
    public static final class ParsedProperties
    {
        ...
        public void setColumnOrder (final Integer [] columnOrder)
        {
        ...
        private Integer [] m_columnOrder; // attribute IDs [order indicates column order] 
        private Integer [] m_sortOrder; // if m_sortOrder[i+1]>0 , sort m_columnOrder[m_sortOrder[i]] in ascending order
...
//    }
    ...
    public static ParsedProperties parseProperties (final IProperties properties, final String type)
    {
        ...
        final Set /* String */ columnNames = new HashSet ();
        {
            ...
            result.setColumnOrder (_columns.toArray(new Integer[0]));
        }
        ...
        
        {
            ...
            final Vector<Integer> _sort = new Vector<Integer> ();
            ...
            for (StringTokenizer tokenizer = new StringTokenizer (sortList, ","); tokenizer.hasMoreTokens (); )
            {
                ...
                result.setSortOrder (_sort.toArray(new Integer[0]));
            }
        }
        {
