                                       ...
                                       implements IReportGenerator
{
        ...
        throws EMMARuntimeException
    {
        ...
        {
            final Integer [] userColumnIDs = m_settings.getColumnOrder ();
            final Vector<Integer> columnIDs = new Vector<Integer> ();
            ...
            if (removed)
            {
                ...
                else
                {
                    ...
                    m_settings.setColumnOrder (columnIDs.toArray(new Integer[0]));
                    
                    final Integer [] userSort = m_settings.getSortOrder ();
                    final Vector<Integer> sort = new Vector<Integer> ();
                    ...
                    m_settings.setSortOrder (sort.toArray(new Integer[0]));
                }
            }
        }
        ...
        {
            final Vector<Integer> orderedAttrIDsWithDir = new Vector<Integer> ();
            ...
            m_typeSortComparators [t] = ItemComparator.Factory.create (orderedAttrIDsWithDir.toArray(new Integer[0]), m_settings.getUnitsType ());
        }
