...
final class ExceptionHandlerTable implements IExceptionHandlerTable
{
	...
	public Object clone ()
    {
        try
        {
            ...
            _clone.m_exceptions = new ArrayList<Exception_info> (exceptions_count);
    ...
    {
        m_exceptions = capacity < 0 ? new ArrayList<Exception_info> () : new ArrayList<Exception_info> (capacity);
    }
