...
final class AttributeCollection implements IAttributeCollection
{
	...
	public Object clone ()
    {
        try
        {
            ...
            _clone.m_attributes = new ArrayList<Attribute_info> (attributes_count);
    ...
    {
        m_attributes = capacity < 0 ? new ArrayList<Attribute_info> () : new ArrayList<Attribute_info> (capacity);
        m_innerClassesAttributeOffset = -1;
    }
